      ...
      <tr>
        ...
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="350" align="left" class="text_cray1"><input name="textfield22" type="text" disabled="true" class="text_cray" id="textfield22" value="${user.username}" readonly="readonly"/></td>
            <td width="230" colspan="-1" rowspan="7" align="center" background="../images/bg_point_write.gif" class="text_cray1"><div id="tp" style="width:120px;height:140px;border:1px solid #233333"></div>              <table width="90%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="15" ></td>
                </tr>
                <tr>
          ...
          <tr>
            ...
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value=${user.username} readonly="readonly"/></td>
          </tr>
          <tr>
            <td width="20" ></td>
