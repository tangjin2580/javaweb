			...
			<tr>
				<td colspan="2"><table width="100%" border="0" cellspacing="0"
					...
					<table width="700" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="350" align="left" class="text_cray1"><input
								name="textfield22" type="text" disabled="true" class="text_cray"
								id="textfield22" value=${user.username } readonly="readonly" /></td>
							<td width="230" colspan="-1" rowspan="7" align="center"
								background="../images/bg_point_write.gif" class="text_cray1"><img
								src="../images/photo_mr.jpg" width="120">
						...
						<tr>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="true" class="text_cray" id="textfield"
						...
						<tr>
							...
							<td width="100" height="30" align="left" class="text_cray1">性
								别：</td>
							<td align="left" class="text_cray1"><input type="radio"
								name="userDTO.sex_code" value="M" readonly="readonly"
								disabled="true" ${user.sex==1?'checked':''} /> <span class="text_cray">
									<label>男</label> <input type="radio" name="userDTO.sex_code"
									value="F" readonly="readonly" disabled="true" " ${user.sex==1?'checked':''}" /> <label>女</label>
						...
						<tr>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="true" class="text_cray" id="textfield1"
								value="${user.province.province}: readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							...
							<td align="left" class="text_cray1"><input name="textfield2"
								...
								value="${user.province.city.city}" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							<td width="100" height="40" align="left" class="text_cray1">证件类型：</td>
							<td align="left" class="text_cray1"><input name="textfield2"
								type="text" disabled="true" class="text_cray" id="textfield3"
								value="二代身份证" readonly="readonly" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							<td width="100" height="40" align="left" class="text_cray1">证件号码：</td>
							<td align="left" class="text_cray1"><input name="textfield6"
								type="text" disabled="disabled" class="text_cray"
								id="textfield6" value="220211199802082258" readonly="true" /></td>
						</tr>
						<tr>
							<td width="20" align="center" class="text_red">*</td>
							<td width="100" height="40" align="left" class="text_cray1">出生日期：</td>
							<td colspan="2" align="left" class="text_cray1"><input
								name="textfield7" type="text" disabled="disabled"
								class="text_cray" id="textfield7" value="1998-2-5"
								readonly="true" /></td>
						</tr>
						<tr>
							<td width="20" height="35"></td>
							<td width="100" height="40" align="left" class="text_cray1">旅客类型：</td>
							<td height="35" colspan="2" align="left" class="text_cray1"><select
						...
						<tr>
							...
							<td height="80" colspan="2" align="left" class="text_cray1"><textarea
									name="textarea" rows="8" class="text_cray" style="width: 100%"></textarea>
							</td>
						</tr>
					</table>
					<br>
					...
					<table width="700" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="164"></td>
							<td width="99" height="30" align="center"><input
								name="button" type="submit" class="buttj" id="button" value=""></td>
							<td width="98"></td>
